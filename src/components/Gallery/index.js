...
class Gallery extends Component {
  ...
  render() {
    ...
    const {imageUrl, imageAltText} = imagesList[imageSelected]
      ...
      <div className="bg-container">
        <div>
          ...
          <div>
            ...
            <p className="side-heading">Nature Photography by Rahul</p>
          </div>
          <ul className="list-container">
            {imagesList.map(eachImg => (
              <ThumbnailItem
                ...
                isSelected={imageSelected === eachImg.id}
              />
            ))}
          </ul>
        </div>
